package cn.joyconn.utils.pay.wxpay;

import cn.joyconn.utils.pay.wxpay.autoconfigure.MyWxPayConfig;
import cn.joyconn.utils.pay.wxpay.autoconfigure.WxPayProperties;
import cn.joyconn.utils.pay.wxpay.model.Coupon;
import cn.joyconn.utils.pay.wxpay.model.CouponRefund;
import cn.joyconn.utils.pay.wxpay.model.OrderRefund;
import cn.joyconn.utils.pay.wxpay.request.*;
import cn.joyconn.utils.pay.wxpay.response.*;
...
//        }
    ...
    public PayResultNoticeRequest parsePayNoticeData(String noticeXml) throws Exception {
        ...
        if (!payResultNotifySignatureValid) {
            getLogger().error("支付通知签名不合法:{}", noticeXml);
        }
